@STATIC;1.0;p;13;CPArray+KVO.ji;9;CPArray.jc;15773;
{
...
{ with(self)
{
    ...
    {
        return objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPArray").super_class }, "valueForKeyPath:", aKeyPath);
    }
}
...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;28160;
...
p;18;CPKeyValueCoding.ji;9;CPArray.ji;10;CPObject.ji;14;CPDictionary.jc;8976;
...
{ with(self)
{
    ...
    return objj_msgSend(objj_msgSend(self, "valueForKey:", firstPart), "valueForKeyPath:", secondPart);
}
...
i;13;CPArray+KVO.jp;21;CPKeyValueObserving.ji;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;10;CPObject.ji;7;CPSet.jc;21572;
{
var the_class = objj_getClass("CPObject")
if(!the_class) objj_exception_throw(new objj_exception(OBJJClassNotFoundException, "*** Could not find definition for class \"CPObject\""));
...
{ with(self)
{
    CPLog("OBSERVE FORWARDING: "+aKeyPath+" "+anObject+" "+(objj_msgSend(anObject, "valueForKeyPath:", aKeyPath))+" "+aContext);
    if (anObject == _object)
    {
...
p;18;CPSortDescriptor.ji;10;CPObject.ji;15;CPObjJRuntime.jc;2938;
CPOrderedAscending = -1;
CPOrderedSame = 0;
CPOrderedDescending = 1;
...
p;20;CPValueTransformer.jI;21;Foundation/CPObject.jI;25;Foundation/CPDictionary.jc;6828;
