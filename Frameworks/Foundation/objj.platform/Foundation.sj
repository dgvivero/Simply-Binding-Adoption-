@STATIC;1.0;p;13;CPArray+KVO.ji;9;CPArray.jc;11460;
...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;18519;
...
p;18;CPKeyValueCoding.ji;9;CPArray.ji;10;CPObject.ji;14;CPDictionary.jc;6064;
var _1=nil,_2=nil;
...
i;13;CPArray+KVO.jp;21;CPKeyValueObserving.ji;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;10;CPObject.ji;7;CPSet.jc;14318;
var _1=objj_getClass("CPObject");
if(!_1){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPObject\""));
}
...
CPLog.warn(_15+" is adding itself as an observer to object: "+_13+" forKeyPath: "+_16+" context: "+_18);
...
with(_95){
CPLog("OBSERVE FORWARDING: "+_97+" "+_98+" "+(objj_msgSend(_98,"valueForKeyPath:",_97))+" "+_9a);
if(_98==_object){
...
p;20;CPValueTransformer.jI;21;Foundation/CPObject.jI;25;Foundation/CPDictionary.jc;4755;
